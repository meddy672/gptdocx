const Static = {
  ...
  SYSTEM_FORMAT: 'When you Return the message content as a json object so that it can be parsed using the JSON.parse static method. The json object needs to be in the in the following format: ',
  APPEND_TO_STRING:{
      ...
      word: ". For the json object fill in all the values for each key."
  },
}
