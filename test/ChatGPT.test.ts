...
import { format as Basic } from '../src/formats/basicExample';
...
describe("GPTDocx", () => {
  ...
  beforeEach(() => {
    chatGPTSpy = jest.spyOn(OpenAI.Chat.Completions.prototype, "create");
    const gptResponse = JSON.parse(responseFormats["basicExample"] as any);
